...
function enqueue_frontend_assets() {
    if (is_singular('cars')) {
        ...
        wp_enqueue_script('fancybox', CAR_RENTAL_CMS_URL . 'assets/vendor/fancybox.umd.js', ['jquery'], null, true);
        wp_enqueue_style('fancybox', CAR_RENTAL_CMS_URL . 'assets/vendor/fancybox.css');
    }
