...
class Car_Features_List_Shortcode
{
    ...
    {
        add_shortcode('car_features_list', [self::class, 'car_features_list_shortcode']); // Register shortcode
    }

    public static function car_features_list_shortcode($atts)
    {
        // Get the current post object
        $post_id = get_the_ID();

        // Get terms associated with the current car post
        ...
        if ($terms && !is_wp_error($terms)) {
            ...
            // Loop through the terms and create the list items
