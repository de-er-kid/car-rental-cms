...
class Settings_Page {
    ...
    public function render_whatsapp_field() {
        $settings = get_option('car_rental_enquiry_settings');
        ?>
        <input type="tel" name="car_rental_enquiry_settings[whatsapp_number]" placeholder="971123456789" value="<?php echo esc_attr(isset($settings['whatsapp_number']) ? $settings['whatsapp_number'] : ''); ?>" />
        <?php
    }
    ...
    public function render_email_field() {
        $settings = get_option('car_rental_enquiry_settings');
        ?>
        <input type="email" name="car_rental_enquiry_settings[email_address]" placeholder="inquiry@example.com" value="<?php echo esc_attr(isset($settings['email_address']) ? $settings['email_address'] : ''); ?>" />
        <?php
    }
    ...
    public function render_phone_field() {
        $settings = get_option('car_rental_enquiry_settings');
        ?>
        <input type="tel" name="car_rental_enquiry_settings[phone_number]" placeholder="+971123456789" value="<?php echo esc_attr(isset($settings['phone_number']) ? $settings['phone_number'] : ''); ?>" />
        <?php
    }
}