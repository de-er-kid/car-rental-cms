...
class Car_Gallery_Metabox
{
    ...
    public function add_gallery_metabox()
    {
        ...
        foreach ($post_types as $post_type) {
            add_meta_box(
                $post_type . '_gallery',
                sprintf(__('Gallery (%s)', 'car-rental-cmc'), ucfirst($post_type)),
    ...
    public function render_gallery_metabox($post)
    {
        ...
        echo '</div>';
        echo '<button id="add-gallery-image" class="button">' . __('Add Image', 'car-rental-cmc') . '</button>';
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $('#add-gallery-image').on('click', function(e) {
                    ...
                    frame = wp.media({
                        title: '<?php echo esc_js(__('Select Images', 'car-rental-cmc')); ?>',
                        button: {
                            text: '<?php echo esc_js(__('Add to Gallery', 'car-rental-cmc')); ?>'
                        },
                        multiple: true
                    });
